...
export const en: Record<string, MessageValue> = {
  ...
  "auth.cloudNotConfigured":
    "Legacy cloud sign-in (Supabase) is not configured. Primary mode is local; Cloudflare sync comes later.",
  ...
  "settings.account.localHint":
    "Data on this device. Cloudflare sync comes later; for now use JSON export/import.",
  ...
  "settings.sync.localOnly":
    "Local mode — no queue. Cloudflare sync by button comes later; use JSON export/import for now.",
