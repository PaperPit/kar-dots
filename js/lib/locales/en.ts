...
export const en: Record<string, MessageValue> = {
  ...
  "settings.account.cloudLabel": "Cloud (legacy): {email}",
  "settings.account.localMode": "Local mode",
  "settings.account.demoMode": "Local mode",
  ...
  "settings.account.signOutDemoTitle": "Leave this mode?",
  "settings.account.signOutCloudText": "Cards stay in the legacy Supabase cloud.",
  "settings.account.signOutLocalText": "Data stays in this browser — you can come back.",
  "settings.account.signOutDemoText": "Data stays in this browser — you can come back.",
  "settings.account.sync": "Sync (legacy)",
  "settings.account.syncHint": "Force-send pending changes to legacy Supabase cloud.",
  "settings.account.syncBtn": "Sync now",
  "settings.account.syncStatsUpdated": "Stats and queue updated",
  "settings.account.switchLocal": "This device only",
  "settings.account.switchLocalHint":
    "Removes the offline queue banner. Export JSON first if you need the same cards locally.",
  "settings.account.switchLocalTitle": "Switch to local mode?",
  "settings.account.switchLocalText":
    "The cloud queue and “Offline” banner will go away. Local storage is separate — export JSON in Settings first if needed.",
  "settings.account.switchLocalBtn": "Switch",
  "settings.account.switchLocalDone": "Local mode enabled",

  "settings.sync.title": "Sync queue (legacy)",
  "settings.sync.localOnly": "Legacy Supabase sync queue is only shown in cloud mode.",
  ...
  "settings.cfSync.never": "never yet",
  "settings.cfSync.emailPlaceholder": "Email",
  "settings.cfSync.passwordPlaceholder": "Password (min. 8 chars)",
  "settings.cfSync.login": "Sign in",
  "settings.cfSync.register": "Create account",
  "settings.cfSync.loginOk": "Signed in",
  "settings.cfSync.registerOk": "Account created",
  "settings.cfSync.syncNow": "Sync now",
  "settings.cfSync.uploadOnly": "Upload only",
  "settings.cfSync.downloadOnly": "Download only",
  "settings.cfSync.pushed": "Uploaded to cloud",
  "settings.cfSync.pulled": "Downloaded from cloud",
  "settings.cfSync.unchanged": "Already up to date",
  "settings.cfSync.pushTitle": "Upload to cloud?",
  "settings.cfSync.pushText": "Local data will replace the Cloudflare snapshot.",
  "settings.cfSync.pushBtn": "Upload",
  "settings.cfSync.pullTitle": "Download from cloud?",
  "settings.cfSync.pullText": "Local data will be replaced by the cloud snapshot.",
  "settings.cfSync.pullBtn": "Download",
  "settings.cfSync.conflictTitle": "Version conflict",
  "settings.cfSync.conflictText": "Cloud has a newer copy. Download cloud and replace local data?",
  "settings.cfSync.conflictPull": "Download cloud",
  "settings.cfSync.signOut": "Sign out",
  "settings.cfSync.signOutTitle": "Sign out of sync?",
  "settings.cfSync.signOutText": "Local data stays on this device.",
  "settings.cfSync.signOutDone": "Signed out of sync",
