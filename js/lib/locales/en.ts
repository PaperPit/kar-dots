...
export const en: Record<string, MessageValue> = {
  ...
  "notes.empty.text":
    "Create one — text with headings and lists, search, and card links.",
  ...
  "notes.editor.bodyPlaceholder": "Write your note…",
  ...
  "notes.cards.linkHint":
    "To link a card: open it in the editor and choose this note in the Note field.",
