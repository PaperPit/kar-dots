...
export const ru = {
  ...
  "stats.section.gradeDist": "Распределение оценок",
  ...
  "notes.cards.linkHint":
    "Выделите текст в заметке и нажмите «Карточка» на панели — карточка привяжется к этой заметке.",
  "notes.cards.empty": "Пока нет связанных карточек.",
  "notes.cards.untitled": "Без текста",
  "notes.folder.label": "Папка",
  "notes.folder.none": "Без папки",
  "notes.folder.all": "Все папки",
  "notes.folder.filter": "Фильтр по папке",
  "notes.tags.empty": "Нет тегов — добавьте #слово в текст",
  "notes.tags.clear": "Сбросить фильтр тега",
  "notes.toolbar.wiki": "[[связь]]",
  "notes.toolbar.image": "Картинка",
  "notes.toolbar.aria": "Форматирование заметки",
  "notes.toolbar.h1": "Заголовок 1",
  "notes.toolbar.h2": "Заголовок 2",
  "notes.toolbar.h3": "Заголовок 3",
  "notes.toolbar.mdLink": "Ссылка [текст](url)",
  "notes.toolbar.lineNumbers": "Номера строк",
  "notes.toolbar.bold": "Жирный",
  "notes.toolbar.italic": "Курсив",
  "notes.toolbar.list": "Список",
  "notes.toolbar.checkbox": "Чекбокс",
  "notes.toolbar.quote": "Цитата",
  "notes.toolbar.code": "Код",
  "notes.cardFromSelection.title": "Карточка из выделения",
  ...
  "notes.unlinked.empty": "Точных упоминаний заголовка вне [[…]] нет.",
  "notes.unlinked.hint": "«Связать» заменит первое упоминание на [[заголовок]].",
  "notes.unlinked.link": "Связать",
  "notes.unlinked.linkTitle": "Сделать wiki-ссылку?",
  "notes.unlinked.linkBody": "Заменить первое упоминание «{title}» на [[…]] в этой заметке?",
  ...
  "notes.localGraph.depth": "Глубина",
  "notes.localGraph.empty": "Нет соседних связей.",
  "notes.image.altPrompt": "Описание картинки (alt)",
  "notes.image.inserted": "Картинка вставлена",
  "notes.backlinks.title": "Ссылки сюда",
  "notes.backlinks.empty": "Пока никто не ссылается на эту заметку.",
  "notes.backlinks.hint": "В другой заметке напишите [[этот заголовок]] — появится здесь.",
  "notes.md.help.title": "Как писать Markdown",
  "notes.md.help.intro":
    "Короткая шпаргалка. В режиме «Просмотр» разметка превращается в оформленный текст.",
  "notes.md.help.h": "Заголовок",
  "notes.md.help.hEx": "Раздел",
  "notes.md.help.bold": "Жирный",
  "notes.md.help.boldEx": "важно",
  "notes.md.help.italic": "Курсив",
  "notes.md.help.italicEx": "акцент",
  "notes.md.help.list": "Список",
  "notes.md.help.listEx": "пункт",
  "notes.md.help.link": "Ссылка",
  "notes.md.help.wiki": "Связь с заметкой",
  "notes.md.help.wikiEx": "Заголовок заметки",
  "notes.md.help.tag": "Хештег",
  "notes.md.help.image": "Картинка с описанием",
  "notes.md.help.imageAlt": "описание",
  "notes.md.help.code": "Код",
  "notes.graph.open": "Граф связей",
  "notes.graph.short": "Граф",
  "notes.graph.title": "Граф заметок",
  "notes.graph.legendNote": "● заметка",
