...
export const ru = {
  ...
  "settings.account.cloudLabel": "Облако (legacy): {email}",
  "settings.account.localMode": "Локальный режим",
  "settings.account.demoMode": "Локальный режим",
  ...
  "settings.account.signOutDemoTitle": "Сменить режим?",
  "settings.account.signOutCloudText": "Карточки останутся в старом облаке Supabase.",
  "settings.account.signOutLocalText": "Данные останутся в этом браузере — вы сможете вернуться.",
  "settings.account.signOutDemoText": "Данные останутся в этом браузере — вы сможете вернуться.",
  "settings.account.sync": "Синхронизация (legacy)",
  "settings.account.syncHint": "Отправить отложенные изменения в старое облако Supabase.",
  "settings.account.syncBtn": "Синхронизировать",
  "settings.account.syncStatsUpdated": "Статистика и очередь обновлены",
  "settings.account.switchLocal": "Только это устройство",
  "settings.account.switchLocalHint":
    "Убрать плашку офлайн-очереди. Сначала экспортируйте JSON, если нужны те же карточки локально.",
  "settings.account.switchLocalTitle": "Перейти на локальный режим?",
  "settings.account.switchLocalText":
    "Облачная очередь и плашка «Нет сети» исчезнут. Локальная база отдельная — при необходимости сначала сделайте экспорт JSON в настройках.",
  "settings.account.switchLocalBtn": "Перейти",
  ...
  "settings.cfSync.never": "ещё не было",
  "settings.cfSync.emailPlaceholder": "Email",
  "settings.cfSync.passwordPlaceholder": "Пароль (мин. 8 символов)",
  "settings.cfSync.login": "Войти",
  "settings.cfSync.register": "Создать аккаунт",
  "settings.cfSync.loginOk": "Вход выполнен",
  "settings.cfSync.registerOk": "Аккаунт создан",
  "settings.cfSync.syncNow": "Синхронизировать",
  "settings.cfSync.uploadOnly": "Только загрузить",
  "settings.cfSync.downloadOnly": "Только скачать",
  "settings.cfSync.pushed": "Данные загружены в облако",
  "settings.cfSync.pulled": "Данные скачаны из облака",
  "settings.cfSync.unchanged": "Уже актуально",
  "settings.cfSync.pushTitle": "Загрузить в облако?",
  "settings.cfSync.pushText": "Локальные данные заменят snapshot в Cloudflare.",
  "settings.cfSync.pushBtn": "Загрузить",
  "settings.cfSync.pullTitle": "Скачать из облака?",
  "settings.cfSync.pullText": "Локальные данные будут заменены облачным snapshot.",
  "settings.cfSync.pullBtn": "Скачать",
  "settings.cfSync.conflictTitle": "Конфликт версий",
  "settings.cfSync.conflictText":
    "На сервере более новая копия. Скачать облако и заменить локальные данные?",
  "settings.cfSync.conflictPull": "Скачать облако",
  "settings.cfSync.signOut": "Выйти",
  "settings.cfSync.signOutTitle": "Выйти из синхронизации?",
  "settings.cfSync.signOutText": "Локальные данные останутся на устройстве.",
  "settings.cfSync.signOutDone": "Вы вышли из синхронизации",
