...
export const ru = {
  ...
  "auth.cloudNotConfigured":
    "Устаревший облачный вход (Supabase) не настроен. Основной режим — локальный; синк через Cloudflare появится позже.",
  ...
  "settings.account.localHint":
    "Данные на этом устройстве. Синхронизация через Cloudflare — в следующих версиях; пока — экспорт/импорт JSON.",
  ...
  "settings.sync.localOnly":
    "Сейчас локальный режим — очереди нет. Синк через Cloudflare по кнопке появится позже; пока используйте экспорт/импорт JSON.",
