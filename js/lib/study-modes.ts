...
export function buildReviewHash(
  folderId: string | null,
  {
    ...
    cramLimit = null,
    noteId = null
  }: { cram?: boolean; mode?: Mode; cramLimit?: number | null; noteId?: string | null } = {}
): string {
...
export function setLastStudyMode(mode: Mode): void {
  ...
  try {
    ...
    console.warn("[kar] setLastStudyMode failed:", e)
  }
}
...
export function setSessionStudyMode(mode: Mode): void {
  ...
  try {
    ...
    console.warn("[kar] setSessionStudyMode failed:", e)
  }
}
...
export function resolveStudyMode(urlMode: string): Mode {
  ...
  try {
    ...
    console.warn("[kar] resolveStudyMode sessionStorage failed:", e)
  }
...
export function setLastPromptSide(side: "front" | "back"): void {
  ...
  try {
    ...
    console.warn("[kar] setLastPromptSide failed:", e)
  }
}
...
export function setSessionPromptSide(side: "front" | "back"): void {
  ...
  try {
    ...
    console.warn("[kar] setSessionPromptSide failed:", e)
  }
  setLastPromptSide(s)
}
...
export function setLastCramLimit(limit: number | null): void {
  try {
    ...
    console.warn("[kar] setLastCramLimit failed:", e)
  }
}
...
export function setSessionCramLimit(limit: number | null): void {
  try {
    ...
    console.warn("[kar] setSessionCramLimit failed:", e)
  }
}
