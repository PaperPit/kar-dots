...
export function createIconPicker(initialIcon: string | undefined): { node: HTMLElement; getIcon: () => string | null } {
  let icon: string | null = folderHasCustomIcon(initialIcon) ? initialIcon || null : null
